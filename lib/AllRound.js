...
/*////////////////////////////////////////////////////////////////////////////////////////
 ...
 이 함수 호출 시 물체 A는 me로 전달하고 물체 B는 target으로 전달한다.
 return 값이 true 이면 두 물체는 서로 교차하고 있는 상태이다.
 ////////////////////////////////////////////////////////////////////////////////////////*/
...
//	해당 월의 마지막 날짜 반환
//	월이 0부터 시작하므로 넘겨받은 month에 -1 값으로 세팅해야한다
function getLastDate(year, month){
	...
	var lastDate=d.getDate();		//	이전 월의 마지막 날
